...
const TABS = [
  ...
  { id: "simulate" as const, href: "/simulate", n: "6", label: "Simulate" },
  { id: "glossary" as const, href: "/glossary", n: "7", label: "Line items" },
];

export function AppNav({
  active,
}: {
  active: "network" | "pnl" | "sensitivity" | "favorable" | "growth" | "simulate" | "glossary";
}) {
  const tab =
